...
<details>
  ...
  **32 bit:**
  ...
  ```
  curl -LO https://github.com/k8sgpt-ai/k8sgpt/releases/download/v1.0.1/k8sgpt_386.rpm
  ...
  **64 bit:**
  ...
  <!---x-release-please-start-version-->
  ```
  curl -LO https://github.com/k8sgpt-ai/k8sgpt/releases/download/v1.0.1/k8sgpt_amd64.rpm
...
<details>
  ...
  **32 bit:**
  <!---x-release-please-start-version-->
  ```
  curl -LO https://github.com/k8sgpt-ai/k8sgpt/releases/download/v1.0.1/k8sgpt_386.deb
  ...
  **64 bit:**
  ...
  <!---x-release-please-start-version-->
  ```
  curl -LO https://github.com/k8sgpt-ai/k8sgpt/releases/download/v1.0.1/k8sgpt_amd64.deb
...
<details>
  ...
  **32 bit:**
  <!---x-release-please-start-version-->
  ```
  curl -LO https://github.com/k8sgpt-ai/k8sgpt/releases/download/v1.0.1/k8sgpt_386.apk
  ...
  **64 bit:**
  <!---x-release-please-start-version-->
  ```
  curl -LO https://github.com/k8sgpt-ai/k8sgpt/releases/download/v1.0.1/k8sgpt_amd64.apk
